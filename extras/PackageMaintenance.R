...
OhdsiRTools::checkUsagePackage("YonseiGLP1")
OhdsiRTools::updateCopyrightYearFolder()
install.packages("devtools")
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/YonseiGLP1.pdf")
shell("R CMD Rd2pdf ./ --output=extras/YonseiGLP1.pdf")
...
OhdsiRTools::createRenvLockFile(rootPackage = "YonseiGLP1",
                                mode = "description",
