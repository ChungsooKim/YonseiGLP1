...
2. Create an empty folder or new RStudio project, and in `R`, use the following code to install the study package and its dependencies:
    ...
    download.file("https://raw.githubusercontent.com/ohdsi-studies/YonseiGLP1/main/renv.lock", "renv.lock")
    renv::init()
    ```  
...
License
=======
The YonseiGLP1 package is licensed under Apache License 2.0

Development
===========
YonseiGLP1 was developed in ATLAS and R Studio.
